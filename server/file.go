...
func uploadFile(w http.ResponseWriter, r *http.Request) {
	...
	for _, fileHeader := range files {
		...
		// TODO нужно брать список поддерживаемых форматов файлов из конфигурации (JSON)
		// TODO и если расширеие файла есть в списке то присваивать ему соответствующий тип
		// TODO поддерживаемые форматы файлов могут быть: tif, kml и тп
