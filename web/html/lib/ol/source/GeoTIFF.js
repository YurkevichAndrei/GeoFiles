 ...
 * @return {Promise<Array<GeoTIFFImage>>} Resolves to a list of img.
 */
 ...
 * reading GeoTIFFs with the purpose of displaying them as RGB img, setting this to `true` will
 * convert other color spaces (YCbCr, CMYK) to RGB.  Setting the option to `'auto'` will make it so CMYK, YCbCr,
 * CIELab, and ICCLab img will automatically be converted to RGB.
...
class GeoTIFFSource extends DataTile {
  ...
  /**
   * Determine the projection of the img in this GeoTIFF.
   * The default implementation looks at the ProjectedCSTypeGeoKey and the GeographicTypeGeoKey
   * of each image in turn.
   * You can override this method in a subclass to support more projections.
   *
   * @param {Array<Array<GeoTIFFImage>>} sources Each source is a list of img
  ...
  /**
   * Determine any transform matrix for the img in this GeoTIFF.
   *
   * @param {Array<Array<GeoTIFFImage>>} sources Each source is a list of img
   * from a single GeoTIFF.
   */
  ...
  /**
   * Configure the tile grid based on img within the source GeoTIFFs.  Each GeoTIFF
