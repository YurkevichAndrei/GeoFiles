...
export type Options = {
    ...
    /**
     * The pixel ratio used by the tile service. For example, if the tile service advertizes 256px by 256px tiles but actually sends 512px by 512px img (for retina/hidpi devices) then `tilePixelRatio` should be set to `2`
     */
 ...
 * @property {number} [tilePixelRatio] The pixel ratio used by the tile service. For example, if the tile service advertizes 256px by 256px tiles but actually sends 512px by 512px img (for retina/hidpi devices) then `tilePixelRatio` should be set to `2`
